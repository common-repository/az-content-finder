...
Tags: content, search, meta, custom, field, text
...
A simple plugin that allows the administrators to search for specific text content in all the posts' meta data
(including nested).
